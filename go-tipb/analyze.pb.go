...
type AnalyzeColumnsReq struct {
	...
	VirtualColExprs        []*Expr               `protobuf:"bytes,11,rep,name=virtual_col_exprs,json=virtualColExprs" json:"virtual_col_exprs,omitempty"`
	XXX_unrecognized       []byte                `json:"-"`
}
...
func (m *AnalyzeColumnsReq) GetVirtualColExprs() []*Expr {
	if m != nil {
		return m.VirtualColExprs
	}
	return nil
}
...
func (m *AnalyzeColumnsReq) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.VirtualColExprs) > 0 {
		for _, msg := range m.VirtualColExprs {
			dAtA[i] = 0x5a
			i++
			i = encodeVarintAnalyze(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *AnalyzeColumnsReq) Size() (n int) {
	...
	if len(m.VirtualColExprs) > 0 {
		for _, e := range m.VirtualColExprs {
			l = e.Size()
			n += 1 + l + sovAnalyze(uint64(l))
		}
	}
...
func (m *AnalyzeColumnsReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VirtualColExprs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VirtualColExprs = append(m.VirtualColExprs, &Expr{})
			if err := m.VirtualColExprs[len(m.VirtualColExprs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorAnalyze = []byte{
	...
	,
}
