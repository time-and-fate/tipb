...
const (
	...
	ExecType_TypeBloomFilter ExecType = 7
)
...
type Executor struct {
	...
	BloomFilter      *BloomFilter `protobuf:"bytes,9,opt,name=bloom_filter,json=bloomFilter" json:"bloom_filter,omitempty"`
...
func (m *Executor) GetBloomFilter() *BloomFilter {
	if m != nil {
...
func (*BloomFilter) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{8} }
...
func (m *Executor) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BloomFilter != nil {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.BloomFilter.Size()))
		n8, err := m.BloomFilter.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *Executor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if err := m.BloomFilter.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorExecutor = []byte{
	...
	,
}
